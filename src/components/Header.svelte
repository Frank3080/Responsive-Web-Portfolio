...
<header class={'sticky  z-[10] top-0 duration-200 px-6 flex items-center justify-between border border-solid ' + (
    ...
    <h1 class="font-medium">
        <b class="font-bold poppins">Frank</b> Ortiz
    </h1>
    ...
    <a  href="mailto:frankortizcarballo@gmail.com" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
        <!--group-hover:translate-x-full, this makes the effect from left to right of the top right button-->
